<?php
  session_start(); 
    ...
    function validate($data){
      ...
      $query= "insert into tb_sugestao(end_ponto, tel_ponto, descarte_ponto, desc_sugestao, id_usuario, data_sugestao) values ('$end_ponto', '$tel_ponto', '$descarte_ponto', '$desc_ponto', '$id_usuario', '$data_sugestao')";
